...
- Add Cronjob to renew SSL certificates and keep Nginx up-to-date: Run `sudo crontab -e` and paste the following line. You should replace `PATH_TO_THIS_REPOSITORY` with the local absolute path of this repository.
```bash
